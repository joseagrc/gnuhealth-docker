...
docker build -q --rm --no-cache -t tryton/tryton:6.2 -t tryton/tryton:latest 6.2
docker build -q --rm --no-cache -t tryton/tryton:6.2-office -t tryton/tryton:office 6.2/office
