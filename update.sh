...
docker build -q --rm --no-cache -t tryton/tryton:5.8 -t tryton/tryton:latest 5.8
docker build -q --rm --no-cache -t tryton/tryton:5.8-office -t tryton/tryton:office 5.8/office
