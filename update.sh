...
docker build -q --rm --no-cache -t tryton/tryton:4.8 -t tryton/tryton:latest 4.8
docker build -q --rm --no-cache -t tryton/tryton:4.8-office -t tryton/tryton:office 4.8/office
